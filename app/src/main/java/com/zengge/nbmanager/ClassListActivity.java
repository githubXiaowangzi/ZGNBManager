...
import com.zengge.dalvik.Parser;
...
public class ClassListActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case ActResConstant.class_list_item:
            ...
            case ActResConstant.add_entry:
                if(mergerDexFile(data.getStringExtra(ZGNBManagerMain.ENTRYPATH)))
    ...
    private boolean mergerDexFile(String name) {
        try {
            ...
            ZGNBManagerMain.showMessage(this, "Open dexFile exception",
                                        e.getMessage());
            return false;
        }
        System.gc();
    ...
    private void showDialogIfChanged() {
        if(isChanged) {
            ZGNBManagerMain.prompt(this, getString(R.string.prompt),
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case R.string.remove_class:
            ...
            ZGNBManagerMain.prompt(this, getString(R.string.is_remove), name,
            new DialogInterface.OnClickListener() {
